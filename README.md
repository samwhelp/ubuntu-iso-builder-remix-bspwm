...
# ubuntu-iso-builder-remix-bspwm
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-bspwm](https://samwhelp.github.io/ubuntu-iso-builder-remix-bspwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-bspwm](https://samwhelp.github.io/ubuntu-iso-builder-respin-bspwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-bspwm](https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-bspwm.git
```


> change dir to `ubuntu-iso-builder-remix-bspwm`

``` sh
cd ubuntu-iso-builder-remix-bspwm
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-bspwm/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-bspwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-bspwm/iso-profile/dist`
